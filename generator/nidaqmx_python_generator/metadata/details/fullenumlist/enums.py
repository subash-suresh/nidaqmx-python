enums = {
    ...
    'CountDirection': {
        'values': [
            ...
            {
                'name': 'EXT_CONTROLLED_PFI',
                'value': 2
            },
            {
                'name': 'EXT_CONTROLLED_RTSI',
                'value': 3
            }
        ]
    },
    ...
    'DataPosition': {
        'values': [
            {
                'name': 'SAMP_CLK_RISING_EDGE',
                'value': 12472
            },
            {
                'name': 'SAMP_CLK_FALLING_EDGE',
                'value': 12473
            },
            {
                'name': 'DELAY_FROM_SAMP_CLK_RISING_EDGE',
                'value': 12474
            },
            {
                'name': 'DELAY_FROM_SAMP_CLK_FALLING_EDGE',
                'value': 12475
            }
        ]
    },
    ...
    'EdgeTriggerCondition': {
        'values': [
            {
                'name': 'CROSS_LOW_THRESHOLD',
                'value': 10469
            },
            {
                'name': 'CROSS_HIGH_THRESHOLD',
                'value': 10470
            },
            {
                'name': 'CROSS_BOTH_THRESHOLDS',
                'value': 10471
            }
        ]
    },
        ...
        'values': [
            {
                ...
                'name': 'EVERY_N_SAMPLES_ACQ_INTO_BUFFER',
                'value': 12580
            },
            {
                'documentation': {
                ...
                'name': 'EVERY_N_SAMPLES_TRANSFERRED_FROM_BUFFER',
                'value': 12581
            },
            {
                'documentation': {
    ...
    'HardwareState': {
        'values': [
            ...
            {
                'name': 'HW_STATE_WAITING_FOR_START_TRIG',
                'value': 100
            },
            {
                'name': 'HW_STATE_RUNNING',
                'value': 200
            },
            {
                'name': 'HW_STATE_WAITING_FOR_REF_TRIG',
                'value': 300
            },
            {
                'name': 'HW_STATE_PAUSED',
                'value': 400
            },
            {
                'name': 'HW_STATE_WAITING_FOR_ADV_TRIG',
                'value': 500
            },
            {
                'name': 'HW_STATE_DONE',
        ...
        'values': [
            {
                ...
                'name': 'REMOTE_VOLTAGE_CALIBRATION',
                'value': 15100
            },
            {
                'documentation': {
                ...
                'name': 'LOCAL_VOLTAGE_CALIBRATION',
                'value': 15101
            },
            {
                'documentation': {
    ...
    'ScaledDataFormat': {
        'values': [
            ...
            },
            {
                ...
                'name': 'COUNTER_DUTY_CYCLE_AND_FREQUENCY_F64',
                'value': 16121
            },
            {
                'documentation': {
                ...
                'name': 'COUNTER_HIGH_AND_LOW_TIMES_F64',
                'value': 16122
            },
            {
                'documentation': {
                ...
                'name': 'COUNTER_HIGH_AND_LOW_TICKS_U32',
                'value': 16123
            },
            {
                'documentation': {
    ...
    'TioCountGateMode': {
        'values': [
            {
                'name': 'COUNT_WHILE_HIGH',
                'value': 0
            },
            {
                'name': 'COUNT_WHILE_LOW',
                'value': 1
            }
        ]
    },
    'TioEdgeType': {
        'values': [
            {
                'name': 'START_ON_RISING',
                'value': 0
            },
            {
                'name': 'START_ON_FALLING',
                'value': 1
            }
        ]
    },
    ...
    'TioPulseType': {
        'values': [
            {
                'name': 'MEASURE_HIGH_PULSES',
                'value': 0
            },
            {
                'name': 'MEASURE_LOW_PULSES',
                'value': 1
            }
        ]
    },
    ...
    'WaveformAttributes': {
        'values': [
            ...
            },
            {
                ...
                'name': 'SAMPS_TIMING_AND_ATTRIBUTES',
                'value': 10141
            }
        ]
    },
