attributes = {
    ...
    'Internal': {
        8619: {
            'access': 'read-write',
            'enum': 'DigitalLineState',
            'name': 'DIGITAL _POWER _UP _STATE',
            'resettable': True,
            'type': 'int32'
        },
        8919: {
            'access': 'read-write',
            'name': 'AO _VOLTAGE _POWER _UP _STATE',
            'resettable': True,
            'type': 'float64'
        },
        8973: {
            'access': 'read-write',
            'name': 'AO _CURRENT _POWER _UP _STATE',
            'resettable': True,
            'type': 'float64'
        },
        8980: {
            'access': 'read-write',
            'name': 'EVERY _N _SAMPLES _ACQ _INTO _BUFFER _EVENT _INTERVAL',
            'resettable': True,
            'type': 'uInt32'
        },
        8981: {
            'access': 'read-write',
            'name': 'EVERY _N _SAMPLES _TRANSFERRED _FROM _BUFFER _EVENT _INTERVAL',
            'resettable': True,
            'type': 'uInt32'
        },
        12205: {
            'access': 'read-write',
            'enum': 'ResistorState',
            'name': 'DIGITAL_RESISTOR_POWER_UP_STATE',
            'resettable': True,
            'type': 'int32'
        },
        12370: {
            ...
            'name': 'INTERNAL_AO_POWER_UP_MODE',
            'resettable': True,
            'type': 'int32'
        }
    },
    ...
    'SwitchChannel': {
        1600: {
            'access': 'read',
            'name': 'SWITCH_CHAN_BANDWIDTH',
            'resettable': False,
            'type': 'float64'
        },
        1601: {
            'access': 'read',
            'name': 'SWITCH_CHAN_IMPEDANCE',
            'resettable': False,
            'type': 'float64'
        },
        1602: {
            'access': 'read',
            'name': 'SWITCH_CHAN_MAX_AC_CARRY_PWR',
            'resettable': False,
            'type': 'float64'
        },
        1603: {
            'access': 'read',
            'name': 'SWITCH_CHAN_MAX_DC_CARRY_PWR',
            'resettable': False,
            'type': 'float64'
        },
        1604: {
            'access': 'read',
            'name': 'SWITCH_CHAN_MAX_AC_SWITCH_PWR',
            'resettable': False,
            'type': 'float64'
        },
        1605: {
            'access': 'read',
            'name': 'SWITCH_CHAN_MAX_DC_SWITCH_CURRENT',
            'resettable': False,
            'type': 'float64'
        },
        1606: {
            'access': 'read',
            'name': 'SWITCH_CHAN_MAX_AC_SWITCH_CURRENT',
            'resettable': False,
            'type': 'float64'
        },
        1607: {
            'access': 'read',
            'name': 'SWITCH_CHAN_MAX_DC_CARRY_CURRENT',
            'resettable': False,
            'type': 'float64'
        },
        1608: {
            'access': 'read',
            'name': 'SWITCH_CHAN_MAX_AC_CARRY_CURRENT',
            'resettable': False,
            'type': 'float64'
        },
        1609: {
            'access': 'read',
            'name': 'SWITCH_CHAN_MAX_DC_SWITCH_PWR',
            'resettable': False,
            'type': 'float64'
        },
        1616: {
            'access': 'read',
            'name': 'SWITCH_CHAN_MAX_DC_VOLTAGE',
            'resettable': False,
            'type': 'float64'
        },
        1617: {
            'access': 'read',
            'name': 'SWITCH_CHAN_MAX_AC_VOLTAGE',
            'resettable': False,
            'type': 'float64'
        },
        6372: {
            ...
            'name': 'SWITCH_CHAN_USAGE',
            'resettable': False,
            'type': 'int32'
        },
        6373: {
            'access': 'read',
            'name': 'SWITCH_CHAN_WIRE_MODE',
            'resettable': False,
            'type': 'uInt32'
        },
        12190: {
            'access': 'read-write',
            'name': 'SWITCH_CHAN_ANLG_BUS_SHARING_ENABLE',
            'resettable': False,
            'type': 'bool32'
        }
    },
    'SwitchDevice': {
        4675: {
            'access': 'read',
            'name': 'SWITCH_DEV_SETTLED',
            'resettable': False,
            'type': 'bool32'
        },
        4676: {
            'access': 'read-write',
            'name': 'SWITCH_DEV_SETTLING_TIME',
            'resettable': False,
            'type': 'float64'
        },
        6106: {
            'access': 'read-write',
            'name': 'SWITCH_DEV_AUTO_CONN_ANLG_BUS',
            'resettable': False,
            'type': 'bool32'
        },
        6108: {
            'access': 'read',
            'name': 'SWITCH_DEV_RELAY_LIST',
            'resettable': False,
            'type': 'char[]'
        },
        6374: {
            'access': 'read',
            'name': 'SWITCH_DEV_NUM_RELAYS',
            'resettable': False,
            'type': 'uInt32'
        },
        6375: {
            'access': 'read',
            'name': 'SWITCH_DEV_SWITCH_CHAN_LIST',
            'resettable': False,
            'type': 'char[]'
        },
        6376: {
            'access': 'read',
            'name': 'SWITCH_DEV_NUM_SWITCH_CHANS',
            'resettable': False,
            'type': 'uInt32'
        },
        6377: {
            'access': 'read',
            'name': 'SWITCH_DEV_NUM_ROWS',
            'resettable': False,
            'type': 'uInt32'
        },
        6378: {
            'access': 'read',
            'name': 'SWITCH_DEV_NUM_COLUMNS',
            'resettable': False,
            'type': 'uInt32'
        },
        6461: {
            'access': 'read',
            'name': 'SWITCH_DEV_TOPOLOGY',
            'resettable': False,
            'type': 'char[]'
        },
        8923: {
            'access': 'read-write',
            'name': 'SWITCH_DEV_PWR_DOWN_LATCH_RELAYS_AFTER_SETTLING',
            'resettable': False,
            'type': 'bool32'
        },
        12314: {
            'access': 'read',
            'name': 'SWITCH_DEV_TEMPERATURE',
            'resettable': False,
            'type': 'float64'
        }
    },
    'SwitchScan': {
        ...
        4680: {
            ...
            'name': 'SWITCH_SCAN_REPEAT_MODE',
            'resettable': True,
            'type': 'int32'
        },
        6105: {
            'access': 'read',
            'name': 'SWITCH_SCAN_WAITING_FOR_ADV',
            'resettable': False,
            'type': 'bool32'
        }
    },
