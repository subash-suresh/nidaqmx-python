...
class AltRef(Enum):
    MSL = 16005  #: Mean sea level (MSL).
    HAE = 16006  #: Height above ellipsoid (HAE).
...
class AntStatus(Enum):
    UNKNOWN = 12588  #: Unknown antenna status.
    NORMAL = 10459  #: Antenna is connected and functioning normally.
    ABSENT = 15994  #: Antenna is absent.
    OVERCURRENT = 15995  #: Overcurrent with the antenna.
...
class NavMeasurementType(Enum):
    ALTITUDE = 15997  #: altitude.
    LONGITUDE = 15998  #: longitude.
    LATITUDE = 15999  #: latitude.
    SPEED_OVER_GROUND = 16000  #: speed over ground.
    TRACK = 16001  #: direction one is traveling relative to one of the North (which?).
    TIMESTAMP = 15986  #: timestamp.
    VERT_VELOCITY = 16003  #: vertical velocity.


class NavMode(Enum):
    MOBILE = 15989  #: Mobile navigation mode.
    STATIONARY_WITH_SURVEY = 15990  #: Stationary with survey navigation mode.
    STATIONARY_WITH_PRESET_LOCATION = 15991  #: Stationary with Preset Location navigation mode.
